...
export const be: Dictionary = {
	...
	'schola.start.heading': 'Калі ўсё гэта вам новае',
	...
	'schola.bible.heading': 'Калі вы ніколі не чыталі Біблію',
	...
	'schola.guide.heading': 'Як тут арыентавацца',
	'schola.guide.lede':
		'Тэкст — гэта ўся старонка; усё астатняе ёсць орган кіравання, які можна не заўважаць, пакуль ён не спатрэбіцца.',
	'schola.guide.top.heading': 'Паласа ўверсе кожнай старонкі',
	'schola.guide.reading.heading': 'Паласа над тэкстам',
	'schola.feature.search':
		'Увядзіце спасылку ў поле ўверсе — раздзел і верш, нумар параграфа, назву дакумента — і яна дапоўніцца падчас набору. Націсніце / або Ctrl+K адкуль заўгодна, і ? для астатніх скаротаў.',
	'schola.feature.languages':
		'Інтэрфейс і тэкст выбіраюцца асобна, дык вы можаце чытаць твор на адной мове, пакуль кнопкі застаюцца на іншай. Там, дзе ў твора некалькі выданняў на вашай мове, вы выбіраеце і між імі.',
	'schola.feature.settings':
		'Памер тэксту, светлы ці цёмны выгляд, сепія, і колькі апарату вы хочаце бачыць побач з тэкстам.',
	...
	'schola.books.heading': 'Што тут ёсць і як гэта цытуецца',
	'schola.books.lede':
	...
	'lectionary.or': 'або',
	'lectionary.notScripture': 'не тэкст Пісання',
