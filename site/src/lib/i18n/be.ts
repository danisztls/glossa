...
export const be: Dictionary = {
	...
	'schola.landing.tagline':
		'Кароткі даведнік па тым, што тут ёсць: чым з’яўляецца кожная з гэтых кніг, дзесяць запаведзяў і іншыя пералікі, якія Касцёл просіць кожнага католіка ведаць, і адкуль пачаць чытанне.',
	...
	'schola.books.heading': 'Што тут ёсць',
	'schola.books.lede':
		'Кожная з гэтых кніг іншага роду, і радок пад ёй кажа, якога менавіта. Адкрыйце поле пошуку ўверсе старонкі, каб убачыць, як на кожную спасылаюцца, і трапіць адразу да месца.',
	...
	'schola.what.questions':
		'Уваход для чытача, які трымае пытанне, а не спасылку. Кожнае пытанне збірае месцы, якія на яго адказваюць, — перш за ўсё з Катэхізіса, — і кожнае слова ў іх належыць самому Касцёлу.',
	...
	'schola.what.census':
		'Што трымае гэтая бібліятэка і як далёка яна сягае — колькі твораў, на якіх мовах, і колькі з кожнага сапраўды даступна чытачу на вашай мове.',
	'schola.formulas.heading': 'Дзесяць запаведзяў і іншае, што вывучаюць на памяць',
	'schola.formulas.lede':
		'Гэта не пераказ гэтага сайта: гэта пералікі, якія сам Касцёл друкуе ў канцы Кампендыума, для кожнага, каго вучаць веры. Кожнае слова ніжэй прыведзена паводле вашага ўласнага выдання.',
	...
	'type.label': 'Памер тэксту і шрыфт',
	...
	'document.kind.apostolicLetter': 'Апостальскі ліст',
	...
	'document.kindPlural.apostolicLetter': 'Апостальскія лісты',
