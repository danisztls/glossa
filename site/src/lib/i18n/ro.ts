...
export const ro: Dictionary = {
	...
	'document.kind.apostolicLetter': 'Scrisoare apostolică',
	...
	'document.kindPlural.apostolicLetter': 'Scrisori apostolice',
	...
	'calendar.national.tagline': '{name}, cu sărbătorile proprii, calculat pentru orice zi.',
