...
export const es: Dictionary = {
	...
	'cues.hint':
		'Subraya los números de referencia y los enlaces, y marca los pasajes guardados y citados, para que nada en la página se distinga solo por el color',
	...
	'bible.landing.continue': 'Continuar donde lo dejaste',
	'bible.landing.start': 'Empezar a leer',
	...
	'colophon.pointNoTracking':
		'Sin analíticas, sin scripts de seguimiento, sin código de terceros. El servidor que te envía estas páginas guarda registros de petición ordinarios, como cualquier servidor web; nada más allá de eso observa lo que lees.',
