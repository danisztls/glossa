...
export const en: Dictionary = {
	...
	// authority, so it is the one that owes a reader the means to check it. The
	// units are named rather than linked because every one of them is printed
	// on this same page a few centimetres below with its number already a link
	// — and the site's prose grammar deliberately refuses a bare siglum, so a
	// citation written for it here would resolve for the canons and not for the
	// Catechism, which is worse than none. The last clause is the only honest
	// thing to say about a text the corpus does not hold.
	'quaestiones.associationes-massonicae.editorial.sources':
		'Everything above is printed or linked on this page: can. 6, 915, 1315 and 1374, and CCC 1385 and 2088, below; the Declaration on Masonic Associations of 26 November 1983 and the declaration of 17 February 1981 under Documents. The 1917 Code itself is not reproduced here.',
