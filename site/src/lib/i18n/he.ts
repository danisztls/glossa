...
export const he: Dictionary = {
	...
	'schola.landing.tagline':
		'מדריך קצר למה שיש כאן: מהו כל אחד מן הספרים האלה, עשרת הדברות ושאר הרשימות שהכנסייה מבקשת מכל קתולי לדעת, ומהיכן להתחיל לקרוא.',
	'schola.start.heading': 'חדשים בקתוליות?',
	...
	'schola.bible.heading': 'מעולם לא קראתם בכתבי הקודש?',
	...
	'schola.books.heading': 'מה יש כאן',
	'schola.books.lede':
		'כל אחד מאלה הוא סוג אחר של ספר, והשורה שמתחתיו אומרת איזה סוג. פתחו את תיבת החיפוש בראש העמוד כדי לראות כיצד מפנים לכל אחד מהם, וכדי להגיע ישירות אל מקום.',
	...
	'schola.what.questions':
		'דרך כניסה לקורא שבידו שאלה ולא הפניה. כל שאלה אוספת את הקטעים העונים עליה — הקטכיזם תחילה — וכל מילה בהם היא של הכנסייה עצמה.',
	...
	'schola.what.census':
		'מה שהספרייה הזאת מכילה ועד כמה היא מגיעה — כמה יצירות, באילו שפות, וכמה מכל אחת קורא בשפתכם יכול למעשה להגיע אליה.',
	'schola.formulas.heading': 'עשרת הדברות, ומה עוד נלמד בעל פה',
	'schola.formulas.lede':
		'לא תמצית של האתר הזה: אלה הרשימות שהכנסייה עצמה מדפיסה בסוף התקציר, לכל מי שמקבל הוראה באמונה. כל מילה למטה מצוטטת מהמהדורה שלכם.',
	...
	'document.kind.apostolicLetter': 'איגרת אפוסטולית',
	...
	'document.kindPlural.apostolicLetter': 'איגרות אפוסטוליות',
	...
	'calendar.national.tagline': '{name}, עם החגיגות המיוחדות לו, מחושב לכל יום.',
