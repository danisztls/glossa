...
export const uk: Dictionary = {
	...
	'schola.start.heading': 'Якщо все це для вас нове',
	...
	'schola.bible.heading': 'Якщо ви ніколи не читали Біблії',
	...
	'schola.guide.heading': 'Як тут орієнтуватися',
	'schola.guide.lede':
		'Текст — це вся сторінка; усе інше є орган керування, який можна не помічати, доки він не знадобиться.',
	'schola.guide.top.heading': 'Смуга вгорі кожної сторінки',
	'schola.guide.reading.heading': 'Смуга над текстом',
	'schola.feature.search':
		'Введіть посилання в поле вгорі — розділ і вірш, номер параграфа, назву документа — і воно доповниться під час набору. Натисніть / або Ctrl+K звідки завгодно, і ? для решти скорочень.',
	'schola.feature.languages':
		'Інтерфейс і текст обираються окремо, тож ви можете читати твір однією мовою, поки кнопки лишаються іншою. Там, де твір має кілька видань вашою мовою, ви обираєте й між ними.',
	'schola.feature.settings':
		'Розмір тексту, світлий чи темний вигляд, сепія, і скільки апарату ви хочете бачити поруч із текстом.',
	...
	'schola.books.heading': 'Що тут є і як це цитується',
	'schola.books.lede':
