...
export const uk: Dictionary = {
	...
	'schola.landing.tagline':
		'Короткий провідник по тому, що тут є: чим є кожна з цих книг, десять Божих заповідей та інші переліки, які Церква хоче, щоб знав кожен католик, і з чого почати читання.',
	...
	'schola.books.heading': 'Що тут є',
	'schola.books.lede':
		'Кожна з цих книг іншого роду, і рядок під нею каже, якого саме. Відкрийте поле пошуку вгорі цієї сторінки, щоб побачити, як на кожну посилаються, і одразу потрапити на місце.',
	...
	'schola.what.questions':
		'Вхід для читача, який має запитання, а не посилання. Кожне запитання збирає місця, що відповідають на нього, — насамперед із Катехизму, — і кожне слово в них належить самій Церкві.',
	...
	'schola.what.census':
		'Що зберігає ця бібліотека і як далеко вона сягає — скільки творів, якими мовами, і скільки з кожного насправді доступно читачеві вашої власної мови.',
	'schola.formulas.heading': 'Десять Божих заповідей і що ще вивчають напам’ять',
	'schola.formulas.lede':
		'Це не короткий виклад цього сайту: це переліки, які сама Церква друкує наприкінці Компендіуму, для кожного, кого навчають віри. Кожне слово нижче наведено з вашого власного видання.',
