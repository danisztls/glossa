...
export const ko: Dictionary = {
	...
	'schola.landing.tagline':
		'여기 있는 것들에 대한 짧은 안내입니다. 이 책들이 각각 무엇인지, 십계명을 비롯해 교회가 가톨릭 신자에게 알아 두기를 요구하는 다른 목록들, 그리고 어디서부터 읽기 시작할지.',
	'schola.start.heading': '가톨릭이 처음이신가요?',
	'schola.start.body': '이렇게 시작하십시오: ',
	'schola.start.bodyAfter':
		'. 교리서와 같은 가르침을 훨씬 짧게, 묻고 답하는 형식으로 담았습니다. 분량은 십분의 일쯤이며, 아무것도 미리 전제하지 않습니다.',
	'schola.bible.heading': '성경을 한 번도 읽어 보지 않으셨나요?',
	...
	'schola.what.catechism':
		'가톨릭 교회가 믿는 바를 한 권으로 간추린 책입니다. 같은 가르침을 묻고 답하는 형식으로 펼친 것으로, 분량은 십분의 일쯤입니다.',
	...
	'schola.what.questions':
		'질문은 있지만 참조는 없는 독자를 위한 입구입니다. 각 항목은 그 물음에 답하는 대목들을 — 먼저 교리서에서부터 — 모아 놓았으며, 그 안의 모든 말은 교회 자신의 것입니다.',
	...
	'settings.label': '설정',
	'apparatus.label': '주해',
	'apparatus.editionNotes': '이 판본의 주',
	'apparatus.commentary': '해설',
	'apparatus.inCommentary': '위 해설에 포함되어 있습니다.',
	'darkMode.label': '어두운 모드',
	'darkMode.auto': '자동',
	'darkMode.on': '켬',
	'darkMode.off': '끔',
	'sepia.label': '세피아',
	'sepia.lightOnly': '밝은 모드에서만',
	'sepia.noHue': '단색에서는 없음',
	'oled.label': 'OLED 블랙',
	'oled.darkOnly': '어두운 모드에서만',
	'mono.label': '단색',
	'mono.hint':
		'전체 쪽을 하나의 회색으로 설정하여, 색으로는 아무것도 구별되지 않게 합니다. 이것이 켜져 있는 동안 세피아는 꺼집니다.',
	'advanced.label': '고급',
	'library.title': '오프라인 서고',
	'library.lede': '이 브라우저에 보관된 본문은 연결이 전혀 없어도 열립니다.',
	'library.essentials': '기도문과 요약',
	'library.illustrations': '성경(삽화)',
	'library.illustrationsDetail': '성경(삽화, 고해상도)',
	'library.other': '그 밖의 본문',
	'library.everything': '전체',
	'library.downloadAll': '전체 내려받기',
	'library.download': '내려받기',
	'library.downloaded': '이 브라우저에 있음',
	'library.offlineNote': '무엇이든 내려받으려면 오프라인 모드를 꺼야 합니다.',
	'library.remove': '이 브라우저에서 없애기',
	'library.removeConfirm': '없애시겠습니까?',
	'library.forget': '내려받은 것 모두 없애기',
	'library.forgetConfirm': '모두 없애시겠습니까?',
	'offline.label': '오프라인 모드',
	'offline.hint':
		'네트워크를 전혀 쓰지 않습니다: 아무것도 내려받지 않고, 업데이트를 확인하지 않으며, 아무것도 측정하지 않습니다. 이미 이 브라우저에 있는 본문만 열립니다.',
	'offline.notDownloaded': '이 브라우저에 없음',
	'loadFailed.title': '불러오지 못했습니다',
	'loadFailed.hint':
		'쪽은 있습니다 — 가져오는 중에 무언가 잘못되었습니다. 다시 시도하면 대개 됩니다.',
	'loadFailed.retry': '다시 시도',
	'loadFailed.retrying': '시도 중…',
	'offline.turnOff': '오프라인 모드 끄기',
	'type.label': '글자 크기와 서체',
	...
	'print.label': '이 쪽 인쇄',
	'toTop.label': '맨 위로',
	'install.label': 'Glossa 설치',
	'install.hint.label': '홈 화면에 추가',
	'install.hint.title': 'Glossa를 홈 화면에 추가하기',
	'install.hint.stepBefore': '앱처럼 열리고 오프라인에서도 읽을 수 있습니다. 아이콘을 누른 뒤',
	'install.hint.stepAfter': '„홈 화면에 추가“를 선택하십시오.',
	'install.hint.dismiss': '닫기',
	'update.label': '새 판이 나왔습니다',
	'update.title': '새 판이 준비되었습니다',
	'update.body': '새로 고침하면 최신 본문과 수정 사항을 받을 수 있습니다.',
	'update.action': '새로 고침',
	'update.dismiss': '나중에',
	'edition.label': '판본',
	...
	'bible.introSource': '머리말은 성경 본문의 일부가 아닙니다.',
	'bible.testament.ot': '구약',
	'bible.testament.nt': '신약',
	...
	'ccc.prevParagraph': '이전 항',
	'ccc.nextParagraph': '다음 항',
	'ccc.inBrief': '간추림',
	...
	'ccc.abbrev': '교리서',
	'ccc.condensedIn': '요약본에서',
	'compendium.abbrev': '요약',
	'compendium.noQuestionNumber': '이 말뭉치에는 물음 번호가 없습니다',
	'document.library.tagline': '회칙, 공의회 헌장, 교령, 그리고 교도권의 선언.',
	'document.filter.heading': '필터',
	'document.filter.author': '저자',
	'document.filter.kind': '종류',
	'document.filter.subject': '주제',
	'document.filter.search': '문헌 검색',
	'document.filter.clear': '지우기',
	'document.filter.results': '표시된 문헌',
	'document.filter.noResults': '이 필터와 일치하는 문헌이 없습니다.',
	'document.tableOfContents': '차례',
	'document.startReading': '읽기 시작',
	'document.readFullDocument': '문헌 전체 읽기',
	'document.section': '절',
	'document.prevSection': '이전',
	'document.nextSection': '다음',
	'document.kind.conciliarConstitution': '헌장',
	'document.kind.conciliarDecree': '교령',
	'document.kind.conciliarDeclaration': '선언',
	'document.kind.encyclical': '회칙',
	'document.kind.apostolicExhortation': '사도적 권고',
	'document.kind.apostolicConstitution': '사도헌장',
	'document.kind.apostolicLetter': '사도적 서한',
	'document.kind.cdfDeclaration': '교리성 선언',
	'document.kind.cdfInstruction': '교리성 훈령',
	'document.kind.cdfLetter': '교리성 서한',
	'document.kind.cdfDoctrinalNote': '교리성 각서',
	'document.kind.cdfResponsum': '교리성 답변',
	'document.kind.cdfConsiderations': '교리성 고찰',
	'document.kindPlural.conciliarConstitution': '헌장',
	'document.kindPlural.conciliarDecree': '교령',
	'document.kindPlural.conciliarDeclaration': '선언',
	'document.kindPlural.encyclical': '회칙',
	'document.kindPlural.apostolicExhortation': '사도적 권고',
	'document.kindPlural.apostolicConstitution': '사도헌장',
	'document.kindPlural.apostolicLetter': '사도적 서한',
	'document.kindPlural.cdfDeclaration': '교리성 선언',
	'citation.unavailable': '이 주에 대한 원문이 없습니다.',
	...
	'summa.tableOfContents': '차례',
	'summa.part': '부',
	'summa.question': '문제',
	'summa.article': '항목',
	'summa.questionShort': '문',
	'summa.articleShort': '항',
	'summa.titleFromEdition': '{lang}판본의 제목',
	'summa.titlesFromEdition': '{lang}판본의 제목 — 이 판본에는 인쇄되어 있지 않습니다',
	'summa.prologue': '머리말',
	'summa.objection': '반론',
	'summa.sedContra': '반대로',
	'summa.corpus': '이렇게 답한다',
	'summa.reply': '반론에 대한 답변',
	'summa.preamble': '비고',
	'summa.prevQuestion': '이전 문제',
	'summa.nextQuestion': '다음 문제',
	'summa.noEditionInYourLanguage':
		'신학대전에는 귀하의 언어로 된 판본이 없습니다. {lang}로 표시됩니다.',
	'summa.noLatinSupplement': '보유편은 영어로만 있습니다 — 아퀴나스가 죽은 뒤에 편찬되었습니다.',
	'index.division': '구분',
	...
	'prayers.prevPrayer': '이전 기도문',
	'prayers.nextPrayer': '다음 기도문',
	'prayers.rosary.today': '오늘',
	'prayers.rosary.todayHeading': '오늘의 신비',
	'prayers.rosary.openingPrayer': '시작 기도',
	'prayers.rosary.decadePrayers': '한 단의 기도문',
	'ref.tooltip.loading': '불러오는 중…',
	'ref.tooltip.openCcc': '교리서에서 열기',
	'ref.tooltip.openBible': '성경에서 열기',
	'ref.tooltip.openCompendium': '요약본에서 열기',
	'ref.preview.open': '열기',
	'ref.cf': '참조',
	...
	'colophon.privacyTitle': '개인정보',
	'colophon.privacyBody1':
		'계정도, 쿠키도, 광고도, 제삼자 코드도 없습니다. 이 사이트를 벗어나서까지 따라오는 것은 아무것도 없습니다.',
	'colophon.privacyBody2':
		'이 사이트가 어떻게 쓰이는지는 셉니다: 방문마다 하나의 측정값을, 모든 항목을 값이 아니라 범위로 — 얼마나 머무르셨는지, 얼마나 자주 오셨는지, 어떤 저작을 여셨는지. 나라는 따로 세며, 나머지와 결합되지 않습니다. 이것은 방문자가 아니라 방문을 나타내며, {days}일 동안 보관됩니다.',
	'colophon.privacyBody3':
		'결코 보내지 않는 것: 검색창에 입력하신 내용, 열어 보신 대목, 또는 이 브라우저를 다시 알아볼 수 있게 하는 무엇이든. 설정과 책갈피와 내려받은 본문은 이 브라우저에 남습니다.',
	...
	'plates.scansBy': '스캔 제공',
	'plates.enlarge': '{title} 확대',
	'plates.zoom': '확대',
	'art.about': '이 그림에 대하여',
	'art.detail': '부분',
	...
	'refs.citedIn': '인용된 곳',
	'refs.externalVolume': '{host}의 제{volume}권 — 스캔한 PDF',
	'bible.wholeChapter': '이 장',
	'bible.verseNotInEdition': '이 절 번호는 이 판본에 없습니다 — 쪽 원문의 주를 참조하십시오',
	'bible.verseAbbrev': '절',
	'bible.note': '주',
	'bible.noteMissing': '이 주는 말뭉치에 없습니다',
	'bible.chapterArgument': '개요',
	'ccc.readFullChapter': '장 전체 읽기',
	'ccc.noParagraphNumber': '이 말뭉치에는 항 번호가 없습니다',
	'copyright.sourceTitle': '원래 출처 쪽 열기',
	'copyright.sourceLabel': '출처',
	'lang.label': '언어',
	'lang.filter': '언어 찾기',
	'lang.more': '다른 언어',
	'notFound.title': '이 주소에는 아무것도 없습니다',
	'notFound.lede': '요청하신 쪽이 여기에 없습니다.',
	'notFound.body':
		'링크가 잘못 입력되었거나 오래되었을 수 있고, 이 사이트에 없는 본문을 가리키고 있을 수도 있습니다.',
	'notFound.searchHint':
		'찾으시는 인용을 알고 계시다면 — 책과 장, 또는 교리서의 항 번호 — 이 쪽 위쪽 검색창에 입력하십시오.',
	'notFound.credit': '영국 도서관 소장 Royal MS 10 E IV, f. 49v을 바탕으로',
	'notFound.elsewhere': '또는 다음 중 하나에서 시작하십시오:',
	'notFound.home': '홈',
	'compare.enter': '판본 비교',
	'compare.exit': '비교 종료',
	'compare.missing': '이 판본에는 없습니다',
	'compare.versificationNote':
		'이 두 판본은 군데군데 이 장의 절을 다르게 나눕니다(번역의 선택이 아니라 본문의 이문입니다) — 같은 절 번호가 두 열에서 항상 같은 문장을 가리키지는 않습니다.',
	'compare.loading': '두 번째 언어를 불러오는 중…',
	'ui.close': '닫기',
	'shortcuts.title': '키보드 단축키',
	'shortcuts.betweenDocuments': '문헌 사이',
	...
	'calendar.national.tagline': '고유 축일을 포함한 {name}을 어느 날짜로든 계산합니다.',
	...
	'lectionary.heading': '미사 독서',
	'lectionary.slot.reading': '독서',
	'lectionary.slot.reading1': '제1독서',
	'lectionary.slot.reading2': '제2독서',
	'lectionary.slot.reading3': '제3독서',
	'lectionary.slot.reading4': '제4독서',
	'lectionary.slot.reading5': '제5독서',
	'lectionary.slot.reading6': '제6독서',
	'lectionary.slot.reading7': '제7독서',
	'lectionary.slot.psalm': '화답송',
	'lectionary.slot.epistle': '서간',
	'lectionary.slot.acclamation': '복음 환호송',
	...
	'lectionary.caveat':
		'미사 독서목록(Ordo Lectionum Missae)이 지정한 본문을, 이 사이트 자체의 판본과 연결한 것입니다 — 특정 교회에서 봉독되는 번역문이 아니며, 주교회의가 일정을 조정할 수도 있습니다.',
