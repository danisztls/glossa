...
export const mg: Dictionary = {
	...
	'type.label': 'Habe sy endriky ny soratra',
	'fontSize.label': 'Haben’ny soratra',
	'fontSize.small': 'Kely',
	'fontSize.medium': 'Antonony',
	'fontSize.large': 'Lehibe',
	'fontSize.xlarge': 'Lehibe kokoa',
	'fontSize.xxlarge': 'Lehibe indrindra',
	'face.label': 'Endri-tsoratra',
	'face.serif': 'Serif',
	'face.sans': 'Sans',
	...
	'document.kind.apostolicLetter': 'Taratasy Apôstôlika',
	...
	'document.kindPlural.apostolicLetter': 'Ireo Taratasy Apôstôlika',
	...
	'calendar.national.tagline':
		'{name}, miaraka amin’ny fankalazana manokana azy, kajiana ho amin’ny andro rehetra.',
