...
export const pt: Dictionary = {
	...
	// outrem. `{sources}` é onde a página insere as unidades, já ligadas e
	// escritas na língua do leitor — não as escreva aqui, e não remova o
	// marcador. Ver o comentário correspondente em `en.ts`.
	'quaestiones.associationes-massonicae.editorial.sources':
		'Tudo o que está acima é impresso ou ligado nesta página: {sources}. O próprio Código de 1917 não está reproduzido aqui.',
