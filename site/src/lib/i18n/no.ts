...
export const no: Dictionary = {
	...
	'schola.what.catechism':
		'En framstilling av det Den katolske kirke tror, i ett bind. Den samme læren lagt fram som spørsmål og svar, omtrent en tidel så langt.',
	...
	'apparatus.editionNotes': 'Denne utgavens noter',
	'apparatus.commentary': 'Kommentar',
	'apparatus.inCommentary': 'Inngår i kommentaren ovenfor.',
	'darkMode.label': 'Mørk modus',
	'darkMode.auto': 'Automatisk',
	'darkMode.on': 'På',
	'darkMode.off': 'Av',
	'sepia.label': 'Sepia',
	'sepia.lightOnly': 'Bare lys modus',
	'sepia.noHue': 'Ikke i mono',
	'oled.label': 'OLED-svart',
	'oled.darkOnly': 'Bare mørk modus',
	'mono.label': 'Monokrom',
	'mono.hint':
		'Setter hele siden i én grå tone, slik at ingenting skilles fra hverandre med farge. Sepia slås av så lenge dette er på.',
	'advanced.label': 'Avansert',
	'library.title': 'Offlinebibliotek',
	'library.lede': 'Tekster som ligger på denne enheten, åpnes helt uten nett.',
	'library.essentials': 'Bønner og Kompendiet',
	'library.illustrations': 'Bibelen (illustrasjoner)',
	'library.illustrationsDetail': 'Bibelen (illustrasjoner, høy oppløsning)',
	'library.other': 'Andre tekster',
	'library.everything': 'Alt',
	'library.downloadAll': 'Last ned alt',
	'library.download': 'Last ned',
	'library.downloaded': 'På denne enheten',
	'library.offlineNote': 'Slå av offlinemodus for å laste ned noe.',
	'library.remove': 'Fjern fra denne enheten',
	'library.removeConfirm': 'Fjern?',
	'library.forget': 'Fjern nedlastinger',
	'library.forgetConfirm': 'Fjern alt?',
	'offline.label': 'Offlinemodus',
	'offline.hint':
		'Bruker ikke nett i det hele tatt: ingenting lastes ned, ingen oppdatering sjekkes, ingenting måles. Bare tekster som allerede finnes på denne enheten, åpnes.',
	'offline.notDownloaded': 'Ikke på denne enheten',
	...
	'offline.turnOff': 'Slå av offlinemodus',
	...
	'install.hint.label': 'Legg til på hjemskjerm',
	'install.hint.title': 'Legg Glossa til på hjemskjermen',
	'install.hint.stepBefore': 'Den åpnes som en app og kan leses offline. Trykk på',
	'install.hint.stepAfter': 'deretter «Legg til på hjemskjerm».',
	'install.hint.dismiss': 'Lukk',
	'update.label': 'En ny utgave er tilgjengelig',
	'update.title': 'En ny utgave er klar',
	'update.body': 'Last inn siden på nytt for å hente de nyeste tekstene og rettelsene.',
	'update.action': 'Last inn på nytt',
	'update.dismiss': 'Ikke nå',
	...
	'bible.introSource': 'Innledningene hører ikke til skriftteksten.',
	...
	'ccc.prevParagraph': 'Forrige avsnitt',
	'ccc.nextParagraph': 'Neste avsnitt',
	...
	'summa.tableOfContents': 'Innhold',
	'summa.part': 'Del',
	'summa.question': 'Spørsmål',
	'summa.article': 'Artikkel',
	'summa.questionShort': 'Sp.',
	'summa.articleShort': 'Art.',
	'summa.titleFromEdition': 'Tittel fra utgaven på {lang}',
	'summa.titlesFromEdition': 'Titler fra utgaven på {lang} — denne trykker ingen',
	'summa.prologue': 'Prolog',
	'summa.objection': 'Innvending',
	'summa.sedContra': 'Derimot',
	'summa.corpus': 'Jeg svarer at',
	'summa.reply': 'Svar på innvending',
	'summa.preamble': 'Note',
	'summa.prevQuestion': 'Forrige spørsmål',
	'summa.nextQuestion': 'Neste spørsmål',
	'summa.noEditionInYourLanguage':
		'Summaen finnes ikke i noen utgave på ditt språk. Her vises utgaven på {lang}.',
	'summa.noLatinSupplement':
		'Tillegget finnes bare på engelsk — det ble satt sammen etter Aquinas’ død.',
	...
	'prayers.prevPrayer': 'Forrige bønn',
	'prayers.nextPrayer': 'Neste bønn',
	'prayers.rosary.today': 'I dag',
	'prayers.rosary.todayHeading': 'Dagens mysterier',
	'prayers.rosary.openingPrayer': 'Åpningsbønn',
	'prayers.rosary.decadePrayers': 'Bønnene i en dekade',
	'ref.tooltip.loading': 'Laster…',
	'ref.tooltip.openCcc': 'Åpne i Katekismen',
	'ref.tooltip.openBible': 'Åpne i Bibelen',
	'ref.tooltip.openCompendium': 'Åpne i Kompendiet',
	'ref.preview.open': 'Åpne',
	'ref.cf': 'jf.',
	...
	'document.filter.search': 'Søk i dokumenter',
	'document.filter.clear': 'Nullstill',
	'document.filter.results': 'Viste dokumenter',
	'document.filter.noResults': 'Ikke noe dokument samsvarer med disse filtrene.',
	'document.tableOfContents': 'Innhold',
	'document.startReading': 'Begynn å lese',
	'document.readFullDocument': 'Les hele dokumentet',
	'document.section': 'Seksjon',
	'document.prevSection': 'Forrige',
	'document.nextSection': 'Neste',
	'document.kind.conciliarConstitution': 'Konstitusjon',
	...
	'document.kind.apostolicConstitution': 'Apostolisk konstitusjon',
	'document.kind.apostolicLetter': 'Apostolisk brev',
	'document.kind.cdfDeclaration': 'CDF-erklæring',
	'document.kind.cdfInstruction': 'CDF-instruks',
	'document.kind.cdfLetter': 'CDF-brev',
	'document.kind.cdfDoctrinalNote': 'CDF-doktrinnote',
	'document.kind.cdfResponsum': 'CDF-responsum',
	'document.kind.cdfConsiderations': 'CDF-overveielser',
	'document.kindPlural.conciliarConstitution': 'Konstitusjoner',
	...
	'document.kindPlural.apostolicConstitution': 'Apostoliske konstitusjoner',
	'document.kindPlural.apostolicLetter': 'Apostoliske brev',
	'document.kindPlural.cdfDeclaration': 'CDF-erklæringer',
	'citation.unavailable': 'Ingen kildetekst tilgjengelig for denne noten.',
	...
	'colophon.privacyTitle': 'Personvern',
	'colophon.privacyBody1':
		'Ingen kontoer, ingen informasjonskapsler, ingen reklame, ingen tredjepartskode. Ingenting her følger deg bort fra dette stedet.',
	'colophon.privacyBody2':
		'Vi teller riktignok hvordan stedet brukes: én måling per besøk, der hvert felt er et intervall snarere enn en verdi — hvor lenge du ble værende, hvor ofte du har vært her, hvilke verk du åpnet. Landet ditt telles separat, uten noe som knytter det til resten. Det beskriver et besøk, ikke en besøkende, og oppbevares i {days} dager.',
	'colophon.privacyBody3':
		'Aldri sendt: det du skriver i søkefeltet, hvilket sted du hadde åpent, eller noe som kunne identifisere enheten din på nytt. Innstillingene, bokmerkene og de nedlastede tekstene dine blir på enheten din.',
	...
	'plates.scansBy': 'Skanninger levert av',
	'plates.enlarge': 'Forstørr {title}',
	'plates.zoom': 'Zoom',
	...
	'refs.citedIn': 'Sitert i',
	'refs.externalVolume': 'Bind {volume} hos {host} — skannet PDF',
	'bible.wholeChapter': 'Dette kapitlet',
	'bible.verseNotInEdition':
		'Dette versnummeret finnes ikke i denne utgaven — se noten i sidens kilde',
	'bible.verseAbbrev': 'v.',
	'bible.note': 'Note',
	'bible.noteMissing': 'Denne noten mangler i korpuset',
	'bible.chapterArgument': 'Innholdsoversikt',
	'ccc.readFullChapter': 'Les hele kapitlet',
	'ccc.noParagraphNumber': 'Ingen avsnittsnummer i dette korpuset',
	...
	'notFound.title': 'Ingenting på denne adressen',
	'notFound.lede': 'Siden du ba om, finnes ikke her.',
	'notFound.body':
		'Lenken kan være feilskrevet eller foreldet, eller den kan peke på en tekst dette stedet ikke har.',
	'notFound.searchHint':
		'Vet du hvilken henvisning du vil ha — en bok og et kapittel, et avsnitt i Katekismen — skriv den inn i søkefeltet øverst på denne siden.',
	'notFound.credit': 'Etter British Library, Royal MS 10 E IV, f. 49v',
	'notFound.elsewhere': 'Eller begynn med en av disse:',
	'notFound.home': 'Hjem',
	'compare.enter': 'Sammenlign utgaver',
	'compare.exit': 'Avslutt sammenligningen',
	'compare.missing': 'Finnes ikke i denne utgaven',
	'compare.versificationNote':
		'Disse to utgavene deler inn dette kapittelets vers ulikt enkelte steder (en tekstvariant, ikke et oversettelsesvalg) — samme versnummer markerer ikke alltid samme setning i begge spaltene.',
	'compare.loading': 'Laster inn det andre språket…',
	'ui.close': 'Lukk',
	...
	'calendar.national.tagline': '{name}, med egne fester, beregnet for hvilken som helst dag.',
	...
	'calendar.plainDays': 'Vanlige hverdager',
	...
	'lectionary.heading': 'Lesninger i messen',
	'lectionary.slot.reading': 'Lesning',
	'lectionary.slot.reading1': 'Første lesning',
	'lectionary.slot.reading2': 'Andre lesning',
	'lectionary.slot.reading3': 'Tredje lesning',
	'lectionary.slot.reading4': 'Fjerde lesning',
	'lectionary.slot.reading5': 'Femte lesning',
	'lectionary.slot.reading6': 'Sjette lesning',
	'lectionary.slot.reading7': 'Sjuende lesning',
	'lectionary.slot.psalm': 'Svarsalme',
	'lectionary.slot.epistle': 'Epistel',
	'lectionary.slot.acclamation': 'Evangelieakklamasjon',
	'lectionary.slot.gospel': 'Evangelium',
	'lectionary.slot.sequence': 'Sekvens',
	'lectionary.or': 'eller',
	'lectionary.cf': 'Jf.',
	'lectionary.about': 'Om disse lesningene',
	'lectionary.caveat':
		'Avsnittene fastsatt av Ordo Lectionum Missae, lenket til dette stedets egne utgaver — ikke den oversettelsen som leses i noen bestemt kirke, og en bispekonferanse kan tilpasse ordningen.',
