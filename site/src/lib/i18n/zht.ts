...
export const zht: Dictionary = {
	...
	'schola.books.lede':
		'這些各是不同種類的書，其下的文字說明是哪一種。請打開本頁頂端的搜尋框，可查看各書如何被引用，並直接抵達某一處。',
	...
	'schola.formulas.heading': '十誡，以及還要背誦的其他內容',
	'schola.formulas.lede':
		'這並非本站的撮要：這些是教會本身印於《簡編》末尾的清單，供任何正在學習教理的人使用。以下每一個字都逐字引自您所用的版本。',
