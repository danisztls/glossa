...
export const ml: Dictionary = {
	...
	'schola.books.lede':
		'ഇവയോരോന്നും വ്യത്യസ്ത തരം ഗ്രന്ഥമാണ്; അതിനു താഴെയുള്ള വരി ഏതു തരമെന്നു പറയുന്നു. പേജിന്റെ മുകളിലുള്ള തിരയൽക്കള്ളി തുറന്നാൽ ഓരോന്നും എങ്ങനെ പരാമർശിക്കപ്പെടുന്നു എന്നു കാണാം, നേരിട്ട് ഒരു ഭാഗത്തും എത്താം.',
	...
	'schola.formulas.heading': 'പത്തു കൽപനകളും മനഃപാഠമാക്കുന്ന മറ്റുള്ളവയും',
	'schola.formulas.lede':
		'ഈ സൈറ്റിന്റെ സംഗ്രഹമല്ല ഇത്: വിശ്വാസം പഠിക്കുന്ന ആർക്കും വേണ്ടി, സംഗ്രഹത്തിന്റെ അവസാനം സഭ തന്നെ അച്ചടിക്കുന്ന പട്ടികകളാണ് ഇവ. താഴെയുള്ള ഓരോ വാക്കും നിങ്ങളുടെ സ്വന്തം പതിപ്പിൽനിന്ന് ഉദ്ധരിച്ചതാണ്.',
