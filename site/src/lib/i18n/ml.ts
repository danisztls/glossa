...
export const ml: Dictionary = {
	...
	'schola.books.heading': 'ഇവിടെ എന്തുണ്ട്, അത് എങ്ങനെ തിരിച്ചറിയുന്നു',
	'schola.books.lede':
	...
	'help.feature.search':
		'മുകളിലെ കള്ളിയിൽ ഒരു പരാമർശം ടൈപ്പു ചെയ്യുക — അധ്യായവും വാക്യവും, ഖണ്ഡികാസംഖ്യ, ഒരു രേഖയുടെ പേര് — ടൈപ്പു ചെയ്യുമ്പോൾത്തന്നെ അതു പൂർത്തിയാകും.',
	...
	'calendar.national.tagline':
		'{territory}: പൊതു റോമൻ കലണ്ടർ അതിന്റെ തനത് ആഘോഷങ്ങളോടെ, ഏതു ദിവസത്തിനും കണക്കാക്കിയത് — അതിന്റെ കാലം, അതിന്റെ പദവി, അതിന്റെ നിറം.',
