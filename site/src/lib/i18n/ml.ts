...
export const ml: Dictionary = {
	...
	'schola.landing.tagline':
		'ഇവിടെയുള്ളതിന്റെ ഒരു ഹ്രസ്വ വഴികാട്ടി: ഈ ഗ്രന്ഥങ്ങൾ ഓരോന്നും എന്താണ്, അതിലേക്കുള്ള പരാമർശം എങ്ങനെ എഴുതുന്നു, ഒരു ഭാഗം എങ്ങനെ കണ്ടെത്താം, സഭ നിർദ്ദേശിച്ചിട്ടുള്ള വായനാക്രമങ്ങൾ.',
	'schola.start.heading': 'ഇതെല്ലാം നിങ്ങൾക്കു പുതിയതെങ്കിൽ',
	...
	'schola.bible.heading': 'നിങ്ങൾ ഒരിക്കലും ബൈബിൾ വായിച്ചിട്ടില്ലെങ്കിൽ',
	...
	'schola.guide.heading': 'വഴി കണ്ടെത്താൻ',
	'schola.guide.lede':
		'പാഠമാണു താൾ മുഴുവൻ; ബാക്കിയെല്ലാം വേണ്ടിവരുവോളം അവഗണിക്കാവുന്ന ഒരു നിയന്ത്രണമാണ്.',
	'schola.guide.top.heading': 'എല്ലാ താളിന്റെയും മുകളിലുള്ള പട്ട',
	'schola.guide.reading.heading': 'ഒരു പാഠത്തിനു മുകളിലുള്ള പട്ട',
	'schola.feature.search':
		'മുകളിലെ കള്ളിയിൽ ഒരു പരാമർശം ടൈപ്പു ചെയ്യുക — അധ്യായവും വാക്യവും, ഖണ്ഡികാസംഖ്യ, ഒരു രേഖയുടെ പേര് — ടൈപ്പു ചെയ്യുമ്പോൾത്തന്നെ അതു പൂർത്തിയാകും. എവിടെനിന്നും / അല്ലെങ്കിൽ Ctrl+K അമർത്തുക; മറ്റു കുറുക്കുവഴികൾക്കു ?.',
	'schola.feature.languages':
		'വിനിമയമുഖവും പാഠവും വെവ്വേറെയാണു തിരഞ്ഞെടുക്കുന്നത്; അതിനാൽ ബട്ടണുകൾ ഒരു ഭാഷയിൽ നിൽക്കെ കൃതി മറ്റൊരു ഭാഷയിൽ വായിക്കാം. നിങ്ങളുടെ ഭാഷയിൽ ഒരു കൃതിക്കു പല പതിപ്പുകളുണ്ടെങ്കിൽ അവയ്ക്കിടയിലും തിരഞ്ഞെടുക്കാം.',
	'schola.feature.settings':
		'അക്ഷരവലുപ്പം, വെളുത്തതോ ഇരുണ്ടതോ, സെപിയ, പാഠത്തിനൊപ്പം എത്ര ടിപ്പണി വേണം എന്നത്.',
	...
	'schola.books.heading': 'ഇവിടെ എന്തുണ്ട്, അതെങ്ങനെ ഉദ്ധരിക്കുന്നു',
	'schola.books.lede':
		'ഇവയോരോന്നും വ്യത്യസ്ത തരം ഗ്രന്ഥമാണ്; ഓരോന്നിനെയും സ്വന്തമായൊരു സംഖ്യകൊണ്ടാണു പരാമർശിക്കുന്നത്. ഉദാഹരണങ്ങൾ രൂപം കാണിക്കുന്നു: അതുപോലൊന്നു തിരയൽക്കള്ളിയിൽ ടൈപ്പു ചെയ്താൽ ആ ഭാഗത്തെത്തും.',
	'schola.cite.label': 'ഉദ്ധരണരൂപം',
	...
	'schola.cite.scripture':
		'പുസ്തകം, അധ്യായം, വാക്യം — നിങ്ങളുടെ പതിപ്പ് അച്ചടിക്കുന്ന ചുരുക്കങ്ങളിൽ',
	...
	'schola.cite.catechism':
		'ഖണ്ഡികാസംഖ്യ പ്രകാരം — ഒന്നാം താൾ മുതൽ അവസാനത്തേതു വരെ മുറിയാതെ ഒഴുകുന്നത്',
	'schola.what.compendium': 'അതേ പ്രബോധനം ചോദ്യോത്തരരൂപത്തിൽ, ഏകദേശം പത്തിലൊന്നു നീളത്തിൽ.',
	'schola.cite.compendium': 'ചോദ്യസംഖ്യ പ്രകാരം',
	...
	'schola.cite.magisterium': 'രേഖയുടെ പേരു പ്രകാരം, പിന്നെ അതിനുള്ളിലെ ഖണ്ഡസംഖ്യ പ്രകാരം',
	'schola.what.social':
	...
	'schola.cite.social': 'ഖണ്ഡികാസംഖ്യ പ്രകാരം, കൃതി തനിക്കായി ഉപയോഗിക്കുന്ന ചുരുക്കത്തിനു കീഴിൽ',
	'schola.what.law':
		'പ്രബോധനമല്ല, നിയമം. സഭ എന്ത് ആവശ്യപ്പെടുന്നു എന്നു പറയുന്നു; ഭേദഗതി ചെയ്യപ്പെടുകയും ചെയ്യുന്നു.',
	'schola.cite.law': 'കാനോൻ പ്രകാരം — അതിന്റെ സംഖ്യയിട്ട ഏകകങ്ങൾ അങ്ങനെയാണ് അറിയപ്പെടുന്നത്',
	'schola.what.doctors':
		'സഭ വേദപാരംഗതരെന്നു പ്രഖ്യാപിച്ച ദൈവശാസ്ത്രജ്ഞർ. ഗ്രന്ഥകർത്താവ് എത്ര വലിയവനായാലും ഇതിന് ഔദ്യോഗിക അധികാരമില്ല.',
	'schola.cite.doctors': 'ഭാഗം, പിന്നെ ചോദ്യം — സുമ്മയുടെ സ്വന്തം വിഭജനങ്ങൾ',
	'schola.what.prayers': 'സഭ പ്രാർഥിക്കുന്ന വാക്കുകൾ, ഒപ്പം ലത്തീനും.',
	'schola.cite.prayers': 'പേരു പ്രകാരം; ഉദ്ധരിക്കാൻ സംഖ്യകളില്ല',
