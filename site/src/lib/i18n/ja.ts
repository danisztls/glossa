...
export const ja: Dictionary = {
	...
	'schola.landing.tagline':
		'ここにあるものの短い案内 — それぞれの書物が何であるか、十戒をはじめ教会がカトリック信者に知っておくよう求めるほかの一覧、そしてどこから読み始めるか。',
	...
	'schola.books.heading': 'ここにあるもの',
	'schola.books.lede':
		'これらはそれぞれ種類の異なる書物であり、その下の行がどの種類かを示します。ページ上部の検索欄を開けば、それぞれがどう示されるかがわかり、そのまま箇所へ進めます。',
	...
	'schola.what.questions':
		'問いはあっても典拠を持たない読者のための入口です。それぞれが、その問いに答える箇所を — まずカテキズムから — 集めており、そこにある一語一語は教会自身のものです。',
	...
	'schola.formulas.heading': '十戒、そしてほかに暗唱で覚えるもの',
	'schola.formulas.lede':
		'本サイトの要約ではありません。これらは信仰を教えられているすべての人のために、教会自身が『要約』の末尾に載せている一覧です。以下の言葉はすべて、あなた自身の版から引用されています。',
	...
	'document.kind.apostolicLetter': '使徒的書簡',
	...
	'document.kindPlural.apostolicLetter': '使徒的書簡',
