/**
 * Trinidad and Tobago — the General Roman Calendar as Trinidad and Tobago’s bishops keep it.
 *
 * A national calendar is a LAYER and not a calendar (see `NationalCalendar` in
 * `../types.ts`): Universal Norms nn. 48–55 describe a particular calendar as
 * the general one with proper celebrations inserted, and a conference does not
 * restate the rest. So this file is only what Trinidad and Tobago actually does
...
export const TRINIDAD_TOBAGO: NationalCalendar = {
	id: 'tt',
	options: { epiphanyOnSunday: true, ascensionOnSunday: true },
	propers: {
		'06-27': [proper('perpetual-help', { en: 'Our Lady of Perpetual Help' }, 'o', { marian: true })]
	},
	overrides: {
