/**
 * Northern Arabia — the General Roman Calendar as Northern Arabia’s bishops keep it.
 *
 * A national calendar is a LAYER and not a calendar (see `NationalCalendar` in
 * `../types.ts`): Universal Norms nn. 48–55 describe a particular calendar as
 * the general one with proper celebrations inserted, and a conference does not
 * restate the rest. So this file is only what Northern Arabia actually does
...
export const NORTHERN_ARABIA: NationalCalendar = {
	id: 'kw',
	alsoCovers: ['bh', 'qa', 'sa'],
	options: { epiphanyOnSunday: true, ascensionOnSunday: true, corpusChristiOnSunday: true },
	propers: {
		'06-27': [proper('perpetual-help', { en: 'Our Lady of Perpetual Help' }, 'm')],
		'10-24': [
			proper('arethas-and-companions', { en: 'Saint Arethas and companions, martyrs' }, 'm', {
				colour: 'red'
			})
		]
	},
