...
- **The Bible is the precedent worth reading first.** Adding `bible.clementina.la` turned an unresolvable "both are faithful" into an adjudicable question — the Latin takes a side in all 31 chapters where EN and PT disagree, PT 25, EN 6, neither 0 (`docs/decisions.md` §Oracles). That is the argument for the against-Latin shape, made once already in another family.
