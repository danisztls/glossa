...
| 17  | **A site-wide subject vocabulary** — _partly done_                     | `/quaestiones` landed 2026-09-09 and is the first topical entry: 12 topics over four doorways, each anchoring spans of the Catechism, with the Scripture and the magisterial citations derived from those paragraphs' own footnotes rather than assigned (`site/docs/topics.md`). WHAT REMAINS is the generalisation this row asked for — the same key space over the Code's canons and the Compendium's questions, and a vocabulary shared with `document-tags.json` rather than a second one beside it. `docs/research/topics.md` holds ~150 further candidates and the held set. | The doorway vocabulary is closed and `sync-corpus.mjs` exits 1 on an unlisted doorway, an unknown CCC paragraph, an unknown canon, an unknown document slug, or a `lead` outside its own spans. Extending the key space has to keep that discipline.                                                                                                                             | Machinery done. What is left is editorial: a topic per reader question, and a held topic waits on a document the corpus does not yet have.                                                                                                                                                                                                                                                                                                                                                                                                           |
