...
— shipped
2026-09-08 with its 32 `census.*` keys in English alone, and is deliberately
...
Sizing: 32 keys in 39 dictionaries, then four small edits and no schema. **Nine
of the 32 are the shelf sentences**, each carrying `{placeholder}` tokens a
